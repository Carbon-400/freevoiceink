...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.carbon400.rawspeech.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("RawSpeechHistoryWindowFrame")
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: VoiceInkEngine) -> NSWindow {
        ...
        window.title = "RawSpeech - Transcription History"
