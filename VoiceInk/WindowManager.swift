...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.carbon400.rawspeech.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.carbon400.rawspeech.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("RawSpeechMainWindowFrame")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "RawSpeech Onboarding"
