        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                CompactHeroSection(
                    ...
                    description: "RawSpeech requires the following permissions to function properly"
                )
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use RawSpeech anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow RawSpeech to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow RawSpeech to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "RawSpeech uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow RawSpeech to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "RawSpeech captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
